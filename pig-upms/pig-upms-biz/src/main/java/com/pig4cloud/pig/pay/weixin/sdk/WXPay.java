...
import static com.pig4cloud.pig.pay.weixin.sdk.WXPayConstants.SignType;
...
public class WXPay {
	...
	public WXPay(final WXPayConfig config) throws Exception {
		this(config, null, true, config.isUseSandbox());
	}

	public WXPay(final WXPayConfig config, final boolean autoReport) throws Exception {
		this(config, null, autoReport, config.isUseSandbox());
	}
	...
	public WXPay(final WXPayConfig config, final String notifyUrl) throws Exception {
		this(config, notifyUrl, true, config.isUseSandbox());
	}

	public WXPay(final WXPayConfig config, final String notifyUrl, final boolean autoReport) throws Exception {
		this(config, notifyUrl, autoReport, config.isUseSandbox());
	}
	...
	private void checkWXPayConfig() throws Exception {
		...
		if (StringUtils.isEmpty(this.config.getNotify_url())) {
			throw new Exception("config.getNotify_url() is null");
		}
	...
	public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
		...
		reqData.put("notify_url", config.getNotify_url() + reqData.get("notify_url"));
