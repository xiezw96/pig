...
import com.pig4cloud.pig.common.security.component.PigUserAuthenticationConverter;
import com.pig4cloud.pig.common.security.component.PigWebResponseExceptionTranslator;
import com.pig4cloud.pig.common.security.extension.filter.AuthenticationFilter;
...
import com.pig4cloud.pig.common.security.util.TokenRequestThreadLocal;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
	...
	public void configure(AuthorizationServerEndpointsConfigurer endpoints) {
		...
		accessTokenConverter.setUserTokenConverter(new PigUserAuthenticationConverter());
		endpoints
			...
			.requestFactory(new DefaultOAuth2RequestFactory(endpoints.getClientDetailsService()) {
				@Override
				public TokenRequest createTokenRequest(Map<String, String> requestParameters, ClientDetails authenticatedClient) {
					TokenRequest tokenRequest = super.createTokenRequest(requestParameters, authenticatedClient);
					ClientDetailsThreadLocal.set(authenticatedClient);
					TokenRequestThreadLocal.set(tokenRequest);
					return tokenRequest;
				}
			});
	}
